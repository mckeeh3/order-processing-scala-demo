...
```shell
> curl -XPOST -H "Content-Type: application/json" localhost:9000/io.mystore.CounterService/GetCurrentCounter -d '{"counterId": "foo"}'
...
```shell
> grpcurl -plaintext -d '{"counterId": "foo"}' localhost:9000 io.mystore.CounterService/GetCurrentCounter 
ERROR:
  Code: Unknown
